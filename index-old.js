...
const memoryDB = {
  ...
  async get(query, params = []) {
    ...
    if (query.includes('receipts')) {
      const [receiptId] = params;
      return receiptRecords.find(r => r.id === receiptId) || null;
    }
    return null;
  },
  ...
  async all(query, params = []) {
    ...
    if (query.includes('receipt_items')) {
      return receiptItemRecords;
    }
    // Return empty array for other tables to prevent errors
    return [];
  }
};
// Initialize receipt data from the SQL script
function initializeReceiptData() {
  // Receipt records based on the SQL script
  receiptRecords = [
    { id: 1, si_number: '000002829', cashier: 'Grace Domingo', receipt_date: '2025-09-18 06:41:20', store: 'CAMILING', gross_amount: 299.00, total_discount: 74.75, net_amount: 224.25, amount_paid: 500.00, change_amount: 275.75, payment_method: 'Cash', vatable_sales: 200.22, vat_amount: 24.01, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 2, si_number: '000002830', cashier: 'Grace Domingo', receipt_date: '2025-09-18 06:41:51', store: 'CAMILING', gross_amount: 81.00, total_discount: 0.00, net_amount: 81.00, amount_paid: 81.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 72.32, vat_amount: 8.68, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 3, si_number: '000002831', cashier: 'Grace Domingo', receipt_date: '2025-09-18 06:51:37', store: 'CAMILING', gross_amount: 136.00, total_discount: 0.00, net_amount: 136.00, amount_paid: 500.00, change_amount: 364.00, payment_method: 'Cash', vatable_sales: 121.43, vat_amount: 14.57, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 4, si_number: '000002832', cashier: 'Grace Domingo', receipt_date: '2025-09-18 06:51:45', store: 'CAMILING', gross_amount: 57.00, total_discount: 0.00, net_amount: 57.00, amount_paid: 57.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 50.89, vat_amount: 6.11, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 5, si_number: '000002833', cashier: 'Grace Domingo', receipt_date: '2025-09-18 06:52:51', store: 'CAMILING', gross_amount: 469.00, total_discount: 2.00, net_amount: 467.00, amount_paid: 467.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 416.96, vat_amount: 50.03, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 6, si_number: '000002834', cashier: 'Grace Domingo', receipt_date: '2025-09-18 07:16:02', store: 'CAMILING', gross_amount: 467.00, total_discount: 2.00, net_amount: 465.00, amount_paid: 500.00, change_amount: 35.00, payment_method: 'Cash', vatable_sales: 415.18, vat_amount: 49.82, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 7, si_number: '000002835', cashier: 'Grace Domingo', receipt_date: '2025-09-18 07:16:35', store: 'CAMILING', gross_amount: 327.00, total_discount: 2.00, net_amount: 325.00, amount_paid: 325.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 290.18, vat_amount: 34.82, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 8, si_number: '000002836', cashier: 'Grace Domingo', receipt_date: '2025-09-18 07:23:14', store: 'CAMILING', gross_amount: 138.00, total_discount: 29.00, net_amount: 109.00, amount_paid: 109.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 97.32, vat_amount: 11.68, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 9, si_number: '000002837', cashier: 'Grace Domingo', receipt_date: '2025-09-18 07:42:46', store: 'CAMILING', gross_amount: 60.00, total_discount: 9.50, net_amount: 50.50, amount_paid: 100.00, change_amount: 49.50, payment_method: 'Cash', vatable_sales: 45.09, vat_amount: 5.41, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 10, si_number: '000002838', cashier: 'Grace Domingo', receipt_date: '2025-09-18 08:10:02', store: 'CAMILING', gross_amount: 50.00, total_discount: 0.00, net_amount: 50.00, amount_paid: 100.00, change_amount: 50.00, payment_method: 'Cash', vatable_sales: 44.64, vat_amount: 5.36, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 11, si_number: '000002839', cashier: 'Grace Domingo', receipt_date: '2025-09-18 08:58:11', store: 'CAMILING', gross_amount: 441.00, total_discount: 2.00, net_amount: 439.00, amount_paid: 439.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 391.96, vat_amount: 47.04, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 12, si_number: '000002840', cashier: 'Grace Domingo', receipt_date: '2025-09-18 09:04:16', store: 'CAMILING', gross_amount: 130.00, total_discount: 6.50, net_amount: 123.50, amount_paid: 200.00, change_amount: 76.50, payment_method: 'Cash', vatable_sales: 110.27, vat_amount: 13.23, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 13, si_number: '000002841', cashier: 'Grace Domingo', receipt_date: '2025-09-18 09:13:56', store: 'CAMILING', gross_amount: 65.00, total_discount: 0.00, net_amount: 65.00, amount_paid: 65.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 58.04, vat_amount: 6.96, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 14, si_number: '000002842', cashier: 'Grace Domingo', receipt_date: '2025-09-18 09:14:15', store: 'CAMILING', gross_amount: 85.00, total_discount: 0.00, net_amount: 85.00, amount_paid: 85.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 75.89, vat_amount: 9.11, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 15, si_number: '000002843', cashier: 'Grace Domingo', receipt_date: '2025-09-18 10:26:44', store: 'CAMILING', gross_amount: 94.00, total_discount: 0.00, net_amount: 94.00, amount_paid: 94.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 83.93, vat_amount: 10.07, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 16, si_number: '000002844', cashier: 'Grace Domingo', receipt_date: '2025-09-18 10:42:48', store: 'CAMILING', gross_amount: 327.00, total_discount: 2.00, net_amount: 325.00, amount_paid: 325.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 290.18, vat_amount: 34.82, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 17, si_number: '000002845', cashier: 'Grace Domingo', receipt_date: '2025-09-18 10:52:35', store: 'CAMILING', gross_amount: 537.00, total_discount: 26.75, net_amount: 510.25, amount_paid: 1000.00, change_amount: 489.75, payment_method: 'Cash', vatable_sales: 455.58, vat_amount: 54.67, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 18, si_number: '000002846', cashier: 'Grace Domingo', receipt_date: '2025-09-18 11:00:27', store: 'CAMILING', gross_amount: 387.00, total_discount: 2.00, net_amount: 385.00, amount_paid: 400.00, change_amount: 15.00, payment_method: 'Cash', vatable_sales: 343.75, vat_amount: 41.25, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 19, si_number: '000002847', cashier: 'Grace Domingo', receipt_date: '2025-09-18 11:25:14', store: 'CAMILING', gross_amount: 32.00, total_discount: 0.00, net_amount: 32.00, amount_paid: 32.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 28.57, vat_amount: 3.43, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 20, si_number: '000002848', cashier: 'Grace Domingo', receipt_date: '2025-09-18 11:51:00', store: 'CAMILING', gross_amount: 308.00, total_discount: 60.00, net_amount: 248.00, amount_paid: 248.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 221.43, vat_amount: 26.57, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 21, si_number: '000002849', cashier: 'Grace Domingo', receipt_date: '2025-09-18 12:14:35', store: 'CAMILING', gross_amount: 52.00, total_discount: 0.00, net_amount: 52.00, amount_paid: 52.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 46.43, vat_amount: 5.57, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() },
    { id: 22, si_number: '000002850', cashier: 'Grace Domingo', receipt_date: '2025-09-18 12:54:39', store: 'CAMILING', gross_amount: 25.00, total_discount: 0.00, net_amount: 25.00, amount_paid: 25.00, change_amount: 0.00, payment_method: 'Cash', vatable_sales: 22.32, vat_amount: 2.68, vat_exempt: 0.00, zero_rated: 0.00, created_at: new Date().toISOString() }
  ];

  // Receipt items based on the SQL script
  receiptItemRecords = [
    // Receipt 1 items
    { id: 1, receipt_id: 1, item_name: 'PETER PANPULLMAN', price: 69.00, quantity: 1, total: 69.00, discount_amount: 17.25, discount_type: 'PERCENTAGE' },
    { id: 2, receipt_id: 1, item_name: 'PETER PANPULLMAN', price: 69.00, quantity: 1, total: 69.00, discount_amount: 17.25, discount_type: 'PERCENTAGE' },
    { id: 3, receipt_id: 1, item_name: 'LOAF  UBE', price: 67.00, quantity: 1, total: 67.00, discount_amount: 16.75, discount_type: 'PERCENTAGE' },
    { id: 4, receipt_id: 1, item_name: 'LOAF  MONGO', price: 57.00, quantity: 1, total: 57.00, discount_amount: 14.25, discount_type: 'PERCENTAGE' },
    { id: 5, receipt_id: 1, item_name: 'ASADO BUN', price: 37.00, quantity: 1, total: 37.00, discount_amount: 9.25, discount_type: 'PERCENTAGE' },
    { id: 6, receipt_id: 1, item_name: 'SCRATCH CARD', price: 0.00, quantity: 1, total: 0.00, discount_amount: 0.00, discount_type: null },

    // Receipt 2 items
    { id: 7, receipt_id: 2, item_name: 'CHOCO LAVA DONUT', price: 27.00, quantity: 2, total: 54.00, discount_amount: 0.00, discount_type: null },
    { id: 8, receipt_id: 2, item_name: 'CHOCO BUTTERNUT DONUT', price: 27.00, quantity: 1, total: 27.00, discount_amount: 0.00, discount_type: null },

    // Receipt 3 items
    { id: 9, receipt_id: 3, item_name: 'EGG PIE', price: 32.00, quantity: 1, total: 32.00, discount_amount: 0.00, discount_type: null },
    { id: 10, receipt_id: 3, item_name: 'CLASSIC PIAYA', price: 59.00, quantity: 1, total: 59.00, discount_amount: 0.00, discount_type: null },
    { id: 11, receipt_id: 3, item_name: 'DULCE ENSAYMADA', price: 45.00, quantity: 1, total: 45.00, discount_amount: 0.00, discount_type: null },

    // Continue with remaining items...
    { id: 12, receipt_id: 4, item_name: 'LOAF  MONGO', price: 57.00, quantity: 1, total: 57.00, discount_amount: 0.00, discount_type: null },
    { id: 13, receipt_id: 5, item_name: 'FAMOUS MOCHA 8x11', price: 465.00, quantity: 1, total: 465.00, discount_amount: 0.00, discount_type: null },
    { id: 14, receipt_id: 5, item_name: 'CANDLE PINK SMALL', price: 2.00, quantity: 1, total: 2.00, discount_amount: 2.00, discount_type: 'PERCENTAGE' },
    { id: 15, receipt_id: 5, item_name: 'CANDLE PINK SMALL', price: 2.00, quantity: 1, total: 2.00, discount_amount: 0.00, discount_type: null },
    { id: 16, receipt_id: 10, item_name: 'COFFEE CAPPUCINO 8 Oz', price: 25.00, quantity: 2, total: 50.00, discount_amount: 0.00, discount_type: null },
    { id: 17, receipt_id: 22, item_name: 'COFFEE AMERICANO 8 Oz', price: 25.00, quantity: 1, total: 25.00, discount_amount: 0.00, discount_type: null }
  ];

  console.log(`Loaded ${receiptRecords.length} receipts and ${receiptItemRecords.length} receipt items`);
}
...
async function initializeDatabase() {
  try {
    ...
    initializeReceiptData(); // Load receipt data
...
app.get('/api/receipts', async (req, res) => {
  try {
    const { store, date, si_number } = req.query;
    ...
    if (date) {
      filteredReceipts = filteredReceipts.filter(receipt =>
        receipt.receipt_date.startsWith(date)
      );
    }

    // Filter by SI number if provided
    if (si_number) {
      filteredReceipts = filteredReceipts.filter(receipt =>
        receipt.si_number.includes(si_number)
      );
    }
...
app.get('/api/receipts/:id', async (req, res) => {
  try {
    ...
    const receipt = receiptRecords.find(r => r.id === receiptId);
    ...
    const items = receiptItemRecords.filter(item => item.receipt_id === receiptId);
...
app.get('/api/receipts/summary/stats', async (req, res) => {
  try {
    ...
    const totalSales = filteredReceipts.reduce((sum, receipt) => sum + receipt.net_amount, 0);
    const totalDiscount = filteredReceipts.reduce((sum, receipt) => sum + receipt.total_discount, 0);
    const totalVat = filteredReceipts.reduce((sum, receipt) => sum + receipt.vat_amount, 0);
    const averageTransaction = totalReceipts > 0 ? totalSales / totalReceipts : 0;
    ...
    filteredReceipts.forEach(receipt => {
      ...
      paymentMethods[method].amount += receipt.net_amount;
    });
...
// Get current version from master site
